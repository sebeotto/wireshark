...
proto_register_dhcp(void)
{
	...
	static hf_register_info hf[] = {
		...
		{ &hf_dhcp_option82_adtran_tlv_91, { "(0x91) DSL-Type                              ", "dhcp.option.agent_information_option.vi.cl.enterprise.option", FT_UINT32, BASE_DEC,  NULL, 0x0, "Option 82:9 VI CL Option", HFILL }},
		{ &hf_dhcp_option82_adtran_tlv_92, { "(0x92) PON-Access-Type                       ", "dhcp.option.agent_information_option.vi.cl.enterprise.option", FT_UINT32, BASE_DEC,  NULL, 0x0, "Option 82:9 VI CL Option", HFILL }},
